...
func (r *ReconcileProducer) applyPodSpec(producer *simv1alpha1.SimulatorProducer, obj metav1.Object, pod *corev1.PodTemplateSpec) {
	...
	pod.Spec.Containers[0].Env = []v1.EnvVar{
		...
		{Name: "ROOT_LOG_LEVEL", Value: producer.Spec.LogLevel},
		...
		{Name: "DEVICE_REGISTRY_TOKEN", ValueFrom: &v1.EnvVarSource{ConfigMapKeyRef: &v1.ConfigMapKeySelector{LocalObjectReference: v1.LocalObjectReference{Name: simulatorName}, Key: "deviceRegistry.token"}}},
